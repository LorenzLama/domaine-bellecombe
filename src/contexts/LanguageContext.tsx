...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "hero.cta.today": { fr: "Découvrir le domaine", en: "Discover the estate" },
  ...
  // Details
  "details.eyebrow": { fr: "Descriptif", en: "Overview" },
  "details.features": { fr: "Caractéristiques", en: "Features" },
  "details.title": { fr: "Le Bien", en: "The Property" },
  "details.description": {
    fr: "Le Domaine de Bellecombe se compose de trois bâtiments implantés au cœur d'un parc de 27,6 hectares : la maison principale, une maison de gardien et une grange.\n\nLe terrain comprend un rivage sur l'Arve, un étang avec pavillon, trois prairies et plus de 20 hectares de forêt. Le site abrite les ruines du Château de Boringe, érigé en 1225 par Pierre de Savoie pour contrôler l'unique pont sur l'Arve entre Genève et Sallanches.\n\nL'ensemble est inscrit au patrimoine remarquable et classé en zone naturelle protégée.",
    en: "The Domaine de Bellecombe comprises three buildings set within a 27.6-hectare park: the main house, a caretaker's house and a barn.\n\nThe grounds include a riverfront along the Arve, a pond with pavilion, three meadows and over 20 hectares of forest. The site holds the ruins of Château de Boringe, built in 1225 by Peter of Savoy to control the only bridge across the Arve between Geneva and Sallanches.\n\nThe entire estate is listed as remarkable heritage and sits within a protected natural zone."
  },
  "details.mainHouse": { fr: "Maison principale : 663 m²", en: "Main house: 663 m²" },
  "details.secondaryHouse": { fr: "Maison de Gardien : 110 m²", en: "Caretaker's house: 110 m²" },
  "details.barn": { fr: "Grange : 150 m²", en: "Barn: 150 m²" },
  "details.land": { fr: "Terrain : 27,6 hectares", en: "Land: 27.6 hectares" },
  "details.forest": { fr: "Forêt : +20 hectares", en: "Forest: +20 hectares" },
  "details.pond": { fr: "Étang avec pavillon", en: "Pond with pavilion" },
  ...
  // Location
  "location.eyebrow": { fr: "Accès", en: "Access" },
  "location.title": { fr: "Situation", en: "Location" },
  "location.destination": { fr: "Destination", en: "Destination" },
  ...
  "contact.heading": { fr: "Prendre Contact", en: "Get in Touch" },
