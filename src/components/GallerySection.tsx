...
const images: GalleryImage[] = [
  ...
  { src: interiorBedroom, alt: "Bedroom", category: "interior", caption: { fr: "La Chambre", en: "The Bedroom" }, size: "small" },
    ...
    <section id="photos" className="section-padding section-spacing">
      ...
      >
        <div className="text-center mb-4">
          <span className="label-text text-muted-foreground">La Galerie</span>
        </div>
          ...
          {filtered.map((img, idx) => {
            ...
            return (
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-foreground/75 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                <figcaption className="absolute bottom-0 left-0 right-0 p-5 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 pointer-events-none">
